...
export function Contact() {
  ...
  const defaultInfo = {
    ...
    bottomSubMessage: "끝까지 살펴봐 주셔서 감사합니다.",
  ...
  const defaultSocialLinks: { name: string; icon: string; url: string }[] = [
    {
      "name": "Mail",
      "icon": "mail",
      "url": "yvulw@dankook.ac.kr"
    },
    {
      "name": "새 링크",
      "icon": "instagram",
      "url": "https://www.instagram.com/iyvulw"
    },
    {
      "name": "새 링크",
      "icon": "youtube",
      "url": "https://www.youtube.com/@yvulw"
    },
    {
      "name": "새 링크",
      "icon": "discord",
      "url": "https://blog.naver.com/yvulw"
    }
  ]
