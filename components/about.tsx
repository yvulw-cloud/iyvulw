...
export function About() {
  ...
  const defaultInfo = {
    ...
    story: [{"text":"\n","buttonColor":"#11126A","desc":"이 활동에 대한 설명을 넣어주세요."},{"text":"2024 단국대학교 사진동아리 DANSA 홍보부원","buttonColor":"#11126A"},{"text":"2022 KT&G 상상프렌즈 14기 B팀 팀장","buttonColor":"#11126A"},{"text":"2022 제주대학교 관광개발학과 기획부장","buttonColor":"#11126A"},{"text":"2021 제5회 대한민국 청년의 날 기획홍보단 이벤트기획팀 팀장","buttonColor":"#11126A"},{"text":"2021 제주대학교 35대 경상대학학생회 ‘시작’ 선거운동본부 홍보국장","buttonColor":"#11126A"},{"text":"2021 제주대학교 관광개발학과  2학년 과대표","buttonColor":"#11126A"},{"text":"2020 제주대학교 학습공동체 기획부장\n","buttonColor":"#11126A"}],
    storyImage: "",
